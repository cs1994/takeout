...
//                }
    ...
    var Upload = {
        ...
        render: function (sel, t) {
            ...
            var upload = '<div class="edui-image-upload%%">' +
                    '<span class="edui-image-icon"></span>' +
                    '<form class="edui-image-form" method="post" enctype="multipart/form-data" target="up">' +
                    '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus '+  ' name='+me.editor.options.imageFieldName +
                ' accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
                    '</form>' +
                    '</div>';
            $(sel, me.dialog).append($(upload.replace(/%%/g, t)));
        ...
        submit: function (callback) {
            ...
            var me = this,
                uploadName = me.editor.options.imageFieldName,
            ...
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {
                ...
                console.log("$(this).parent()[0].submit()1");
                $(this).parent()[0].submit();
                console.log("$(this).parent()[0].submit()2");
